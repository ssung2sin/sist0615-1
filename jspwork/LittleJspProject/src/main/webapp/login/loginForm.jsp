...
<body>
	<div class="loginform">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<b style="font-size: 1.5em;font-family: Sunflower;"><img src="../cartoon/sistgood.png" width="50" height="30">학적관리 통합시스템</b>
			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<button type="button" class="btn btn-info" onclick="location.href='../myschool/myschoolMain.jsp'">비로그인 접속</button><br>
